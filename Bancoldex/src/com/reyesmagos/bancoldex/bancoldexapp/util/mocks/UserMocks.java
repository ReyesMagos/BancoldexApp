...
public class UserMocks {
	...
	public void setNationalBusinessManUser() {
		NationalBusinessManUser businessMan = new NationalBusinessManUser();
		businessMan.setNit("890936694");
		businessMan.setSector("Tecnología");
		businessMan.setSubSectro("Desarrollo");
		List<String> partners = new ArrayList<String>();
		partners.add("Felipe Correa");
		partners.add("Laura Osorio");
		businessMan.setPartners(partners);
		this.nationalBusinessManUser = nationalBusinessManUser;
	}
	...
	public String[] getObjects(int option) {
		...
		String[] obj3 = { "banco1@banco.com", "Crediticio", "MiPymes",
				"Grande Empresa", "Bancolombia, Davivienda", "Medellín",
				"Antioquia", "Calle 56 # 75 - 67", "Banco1", "Jose Carvajal",
				"Economía" };
